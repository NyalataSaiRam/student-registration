...
import { add, editMode, update_courses } from '../store/courses.slice';
...
const Courses = () => {
    ...
    const changeEditMode = (id, name) => {
        ...
        courses.forEach(c => {
            if (c.editMode && c.id !== id) {
                dispatch(editMode({ id: c.id, toggleState: false }));
            }
        });
    ...
    const update = (id) => {
        ...
        dispatch(update_courses({ id: id, name: inputValue }));
        ...
        <motion.div
            ...
            <div className='p-2'>
                <div className='flex justify-between'>
                    <h1 className='capitalize rrs'>courses</h1>
                    ...
                    <div className='flex items-center justify-center w-full h-full flex-col '>
                        <div className='flex flex-col items-center justify-center border-1 border-blue p-4 w-[30%]'>
                            <div className='w-full py-2 px-6 rounded flex flex-col'>
                                <label htmlFor="newCourseType" className='rrs'>Course name</label>
